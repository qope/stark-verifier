...
contract Halo2Verifier {
    ...
    uint256 internal constant NUM_INSTANCE_CPTR = 0x1824;
    uint256 internal constant     INSTANCE_CPTR = 0x1844;
    ...
    function verifyProof(
        ...
        assembly {
...

            {
                ...
                success := and(success, eq(0x17a0, calldataload(PROOF_LEN_CPTR)))
                ...
                // Read evaluations
                for
                    { let proof_cptr_end := add(proof_cptr, 0x0ae0) }
                    lt(proof_cptr, proof_cptr_end)
                    {}
                {
            ...
            // Compute quotient evavluation
            {
                ...
                {
                    let f_3 := calldataload(0x0f84)
                    let var0 := 0x2
                    let var1 := sub(r, f_3)
                    let var2 := addmod(var0, var1, r)
                    let var3 := mulmod(f_3, var2, r)
                    let a_3 := calldataload(0x0d44)
                    let var4 := 0x000000000000000000000000000000000000000000000000ffffffff00000001
                    let var5 := sub(r, var4)
                    let var6 := addmod(a_3, var5, r)
                    let a_4 := calldataload(0x0d24)
                    let var7 := addmod(var6, a_4, r)
                ...
                }
                {
                    ...
                    let var4 := mulmod(a_0, a_1, r)
                    let var5 := 0x7
                    let a_0_next_1 := calldataload(0x0e84)
                    let var6 := mulmod(var5, a_0_next_1, r)
                    let a_1_next_1 := calldataload(0x0ea4)
                    let var7 := mulmod(var6, a_1_next_1, r)
                    let var8 := addmod(var4, var7, r)
                    let a_2 := calldataload(0x0d04)
                    let var9 := addmod(var8, a_2, r)
                    let var10 := 0x000000000000000000000000000000000000000000000000ffffffff00000001
                    let a_3 := calldataload(0x0d44)
                    let var11 := mulmod(var10, a_3, r)
                    let a_4 := calldataload(0x0d24)
                    let var12 := addmod(var11, a_4, r)
                    let var13 := sub(r, var12)
                    let var14 := addmod(var9, var13, r)
                    let var15 := mulmod(var3, var14, r)
                ...
                }
                {
                    ...
                    let a_0 := calldataload(0x0cc4)
                    let a_1_next_1 := calldataload(0x0ea4)
                    let var4 := mulmod(a_0, a_1_next_1, r)
                    let a_0_next_1 := calldataload(0x0e84)
                    let a_1 := calldataload(0x0ce4)
                    let var5 := mulmod(a_0_next_1, a_1, r)
                    let var6 := addmod(var4, var5, r)
                    let a_2_next_1 := calldataload(0x0ec4)
                    let var7 := addmod(var6, a_2_next_1, r)
                    let var8 := 0x000000000000000000000000000000000000000000000000ffffffff00000001
                    let a_3_next_1 := calldataload(0x0ee4)
                    let var9 := mulmod(var8, a_3_next_1, r)
                    let a_4_next_1 := calldataload(0x0f04)
                    let var10 := addmod(var9, a_4_next_1, r)
                    let var11 := sub(r, var10)
                    let var12 := addmod(var7, var11, r)
                    let var13 := mulmod(var3, var12, r)
                ...
                {
                    let perm_z_last := calldataload(0x11c4)
                ...
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x11c4), sub(r, calldataload(0x11a4)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0cc4), mulmod(beta, calldataload(0x0fc4), r), r), gamma, r), r)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0ce4), mulmod(beta, calldataload(0x0fe4), r), r), gamma, r), r)
                ...
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0d04), mulmod(beta, calldataload(0x1004), r), r), gamma, r), r)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0d24), mulmod(beta, calldataload(0x1024), r), r), gamma, r), r)
                ...
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0d44), mulmod(beta, calldataload(0x1044), r), r), gamma, r), r)
                    lhs := mulmod(lhs, addmod(addmod(mload(INSTANCE_EVAL_MPTR), mulmod(beta, calldataload(0x1064), r), r), gamma, r), r)
                ...
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0f24), mulmod(beta, calldataload(0x1084), r), r), gamma, r), r)
                    rhs := mulmod(rhs, addmod(addmod(calldataload(0x0f24), mload(0x00), r), gamma, r), r)
                    let left_sub_right := addmod(lhs, sub(r, rhs), r)
                    let eval := addmod(left_sub_right, sub(r, mulmod(left_sub_right, addmod(mload(L_LAST_MPTR), mload(L_BLIND_MPTR), r), r)), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                ...
                {
                    let l_0 := mload(L_0_MPTR)
                    let eval := addmod(l_0, mulmod(l_0, sub(r, calldataload(0x1704)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let l_last := mload(L_LAST_MPTR)
                    let eval := mulmod(l_last, addmod(mulmod(calldataload(0x1704), calldataload(0x1704), r), sub(r, calldataload(0x1704)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let theta := mload(THETA_MPTR)
                    ...
                    let beta := mload(BETA_MPTR)
                    let gamma := mload(GAMMA_MPTR)
                    let lhs := mulmod(calldataload(0x1724), mulmod(addmod(calldataload(0x1744), beta, r), addmod(calldataload(0x1784), gamma, r), r), r)
                    let rhs := mulmod(calldataload(0x1704), mulmod(addmod(input, beta, r), addmod(table, gamma, r), r), r)
                    let eval := mulmod(addmod(1, sub(r, addmod(mload(L_BLIND_MPTR), mload(L_LAST_MPTR), r)), r), addmod(lhs, sub(r, rhs), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x1744), sub(r, calldataload(0x1784)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(addmod(1, sub(r, addmod(mload(L_BLIND_MPTR), mload(L_LAST_MPTR), r)), r), mulmod(addmod(calldataload(0x1744), sub(r, calldataload(0x1784)), r), addmod(calldataload(0x1744), sub(r, calldataload(0x1764)), r), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
            ...
            // Compute pairing lhs and rhs
            {
                ...
                }
                {
                    ...
                    let r_eval := 0
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x1704), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x1724), r), r)
                    ...
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x15c4), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x15e4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x1524), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x1544), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x1484), r), r)
                    ...
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x1344), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x1364), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x12a4), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x12c4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x1204), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x1224), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x11c4), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x11e4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x0d44), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x0ee4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x0d24), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x0f04), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x0d04), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x0ec4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x0ce4), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x0ea4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x20), calldataload(0x0cc4), r), r)
                ...
                }
                {
                    ...
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(coeff, calldataload(0x1784), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                ...
                }
                {
                    ...
                    mstore(0x00, calldataload(0x0b84))
                    mstore(0x20, calldataload(0x0ba4))
                    for
                        {
                            let mptr := 0x0b44
                            let mptr_end := 0x0904
                    ...
                    success := ec_add_acc(success, mload(0x80), mload(0xa0))
                    mstore(0x80, calldataload(0x17a4))
                    mstore(0xa0, calldataload(0x17c4))
                    ...
                    mstore(PAIRING_RHS_X_MPTR, calldataload(0x17e4))
                    mstore(PAIRING_RHS_Y_MPTR, calldataload(0x1804))
                }
            }
